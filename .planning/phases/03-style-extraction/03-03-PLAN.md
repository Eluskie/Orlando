...
must_haves:
  truths:
    ...
    - "Extracted style is saved to brand in database"
...
- API endpoint to persist extracted style to brand
...
<task type="auto">
  <name>Task 2: Create Moodboard component and style persistence</name>
  <files>
    src/components/brand/moodboard.tsx
    src/app/api/brands/[brandId]/style/route.ts
    src/app/(chat)/[brandId]/page.tsx
  ...
  <action>
1. Create src/app/api/brands/[brandId]/style/route.ts for style persistence:
...
2. Create src/components/brand/moodboard.tsx:
...
3. Update src/app/(chat)/[brandId]/page.tsx to include moodboard section:
...
For simplicity in this phase, integrate as a collapsible section below the chat when style exists.
  ...
  <verify>
    ...
    - Style API endpoint accepts PATCH with extracted style
    - Brand page shows moodboard section when style exists
  </verify>
  <done>
    Moodboard component displays references and extracted style. Style persistence API saves to brand. Brand page integrates moodboard view.
  </done>
</task>
...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>
    ...
    3. Visual feedback with StyleExtractionCard
    4. Brand moodboard showing references + extracted style
  </what-built>
  <how-to-verify>
    ...
    10. Refresh page - verify style persists (if brand was saved)
  </how-to-verify>
...
3. Integration check:
   ...
   - End-to-end flow: upload -> extract -> display -> persist
...
- Style persistence API saves to brand record
- Brand page integrates moodboard view
- User can verify full extraction flow works end-to-end
</success_criteria>
